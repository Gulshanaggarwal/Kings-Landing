            ...
            <div className="w-5/6 py-4 px-2 mx-auto my-16 bg-white rounded-md sm:w-2/3 md:w-1/2 xl:w-1/3">
                ...
                <form className="w-full my-2">
                    <div className="flex flex-col">
                        ...
                        <input type="email" className="rounded-md px-2 py-2 bg-indigo-100 outline-none focus:ring-1 focus:ring-gray-900" autoComplete='' onChange={(e) => setuserName(e.target.value.trim())} />
                    </div>
                    <div className="flex flex-col">
                        <label className="py-2">Password</label>
                        <input type="password" className="rounded-md px-2 py-2 bg-indigo-100 outline-none focus:ring-1 focus:ring-gray-900" autoComplete='' onChange={(e) => setPassword(e.target.value.trim())} />
                    </div>
