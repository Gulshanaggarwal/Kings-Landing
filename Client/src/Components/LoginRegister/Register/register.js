...
export default function Register() {
    ...
    return (
        <div className="bg-black-transparent fixed top-0 left-0 w-full h-full text-xs">
            <div className="w-5/6 py-3 px-2 my-16 mx-auto bg-white rounded-md sm:w-2/3 md:w-1/2 xl:w-1/3">
                ...
                <form className="w-full my-2">
                    <div className="flex flex-col">
                        ...
                        <input type="text" className="rounded-md px-2 py-2 bg-indigo-100 outline-none focus:ring-1 focus:ring-gray-900" required onChange={(e) => setfullName(e.target.value.trim())} autoFocus />
                    </div>
                    <div className="flex flex-col">
                        <label className="py-2">Email</label>
                        <input type="email" className="rounded-md px-2 py-2 bg-indigo-100 outline-none focus:ring-1 focus:ring-gray-900" required onChange={(e) => setuserName(e.target.value.trim())} />
                    </div>
                    <div className="flex flex-col">
