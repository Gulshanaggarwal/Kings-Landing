    ...
    return (
        <div className="bg-black-transparent fixed top-0 left-0 w-full h-full">
            <div className="w-5/6 p-4 mx-auto my-16 bg-white rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 float-right cursor-pointer" viewBox="0 0 20 20" fill="currentColor" onClick={()=>dispatch(hideRegisterOTP())}>
                    <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
                <h3 className="font-medium text-xl text-center">Enter OTP</h3>
                <p className="text-center text-green-500">OTP sent successfully !</p>
                <form className="flex flex-col w-5/6 mx-auto my-4">
                    <input type="text" className="text-center py-2" placeholder="Enter 6 digit OTP" required onChange={(e)=>setOTP(e.target.value.trim())}/>
                ...
                <div>
                    ...
                    <button className="underline px-2">Resend</button>
                </div>
            </div>
        </div>
    )
