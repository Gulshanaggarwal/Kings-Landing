    ...
    return (
        <main>
            ...
            {residency.length > 0 && residency.map((ele) => {
                ...
                return (
                    <div className='w-90P mx-auto my-12 border-1 border-gray-600 rounded-md bg-indigo-50 text-2lsxs 271-300px:text-lsxs 301-330px:text-gtxs 331-360px:text-ls1rem' key={ele._id}>
                        ...
                        <div className='px-2 py-5'>
                            ...
                            <div className="py-2 flex items-center space-x-1">
                                ...
                                <svg class="svg-icon w-4 h-4 block" viewBox="0 0 20 20">
                            ...
                            <div className="flex justify-between mt-4">
                                ...
                                <button type="button" onClick={() => dispatch(showBookingForm({ data: { residencyId: ele._id, residencyName: ele.name, residencyType: ele.residencyType } }))} className='rounded-md px-3 h-10  bg-indigo-400 text-xs text-white font-medium'>Book now</button>
                            </div>
                        </div>
                    </div>
                )
